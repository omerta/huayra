...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->line(480,695,480,760);
		$io_pdf->line(480,730,585,730);
        $io_pdf->Rectangle(15,695,570,65);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,698,100,60); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=296-($li_tm/2);
		$io_pdf->addText(205,720,16,$as_titulo); // Agregar el título
		...
		$io_pdf->line(15,132,585,132);		
		$io_pdf->line(15,117,585,117);
		
		$io_pdf->line(128,60,128,145);		
		$io_pdf->line(238,60,238,145);		
		$io_pdf->line(353,60,353,145);		
		$io_pdf->line(463,60,463,145);	
		
		$io_pdf->addText(40,136,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(44,122,7,"ESPECIALISTA"); // Agregar el título
		$io_pdf->addText(32,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		
		$io_pdf->addText(155,136,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(150,122,7,"GCIA. PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(142,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		
		$io_pdf->addText(268,136,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(244,122,6,"DIRECTOR DE ADMON. y FINANZAS"); // Agregar el título
		$io_pdf->addText(255,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		
		$io_pdf->addText(379,136,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(360,122,7,"OFICINA DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(370,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título

		$io_pdf->addText(493,136,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(472,122,7,"PRESIDENTE DE LA EMPRESA"); // Agregar el título
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>510), // Justificación y ancho de la columna
						 			   'totpre'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('sc_cuenta'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>355), // Justificación y ancho de la columna
						 			   'mondeb'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'monhab'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'cols'=>array('sc_cuenta'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>355), // Justificación y ancho de la columna
						 			   'mondeb'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'monhab'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($aa_data,$la_columnas,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>430), // Justificación y ancho de la columna
						 			   'totdeb'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'tothab'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	...
	function uf_print_carded($la_datacar,&$io_pdf)
	{
		...
		//       Function: uf_print_detalle_cuentas
		//		   Access: private 
		//	    Arguments: la_datacar // arreglo de información			   
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: función que imprime el detalle de los Cargos y Deducciones
		//	   Creado Por: Ing. Yesenia Moreno / Ing. Luis Lang
		// Fecha Creación: 27/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_configcar=array('showHeadings'=>1, 
						    'fontSize' =>6, 
						    'titleFontSize' =>9,  
						    'showLines'=>1, 
						    'shaded'=>0, 
						    ...
						    'maxWidth'=>500, 
						    'xPos'=>290, 
						    'cols'=>array('denominacion'=>array('justification'=>'center','width'=>230),      
						 			      'monobjret'=>array('justification'=>'center','width'=>100),  
						 			      'objret'=>array('justification'=>'right','width'=>100)        
									     )
						   ); 
		$io_pdf->ezTable($la_datacar,$la_columnacar,'',$la_configcar);			
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,6.2,3,3); // Configuración de los margenes en centímetros
...
//////////////////////////      GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
	...
	//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
                    ...
                    //////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
					//-------------------------------CARGOS-------------------------------------- 										                       									
						$lb_validocar=$io_report->uf_select_sol_cargos($ls_numsol);
						$b=0; 
														
						//-------------------------------DEDUCCIONES--------------------------------------
						$li_totdet=0;
						$lb_validoded=$io_report->uf_select_sol_deducciones($ls_numsol);
