...
class sigesp_saf_c_condicion
{
	...
	//////////////////////////////////////////////////////////////////////////////
		...
		if($li_exec===false)
		{
			$this->io_msg->message("CLASE->condicion M�TODO->uf_saf_select_condicion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
  ...
  function uf_generar_num_conbie()
    ...
    $this->io_sql->begin_transaction();
		...
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="INSERT";
			$ls_descripcion ="Insert&oacute; la Condici&oacute;n del bien ".$as_codigo;
    ...
    $this->io_sql->begin_transaction();
		...
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific&oacute; la Condici&oacute;n del bien ".$as_codigo;
			$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			if($ls_variable[0] == false)
