...
class class_funciones_activos
{
  ...
  //-----------------------------------------------------------------------------------------------------------------------------------
   ...
   function uf_convertirformatonumerico($ai_valor)
   {
	...
	/**
	 * FunciÃ³n que obtiene el valor de una variable que viene de un submit.
	 *
	 ...
	 * @param string $as_permisos Permiso si puede entrar o no a la pÃ¡gina
   ...
   function uf_load_seguridad($as_sistema,$as_ventanas,&$as_permisos,&$aa_seguridad,&$aa_permisos)
   {
	 ...
	 /**
 		* FunciÃ³n que imprime el permiso de seguridad en las pÃ¡ginas.
 		*
 		* @param boole $as_permisos Permisos que tiene el usuario en la pÃ¡gina
 		* @param array $aa_permisos Arreglo de permisos (incluir, modificar, eliminar, etc)
 		* @param string $as_logusr Nombre de usuario
 		* @param string $as_accion AcciÃ³n que va a ejecutar si no tiene permiso el usuario.
 		*
 		* @author Yesenia Moreno 2006
 		*/
