...
class sigesp_saf_class_report {
    ...
    function uf_saf_load_movimiento($as_codemp, $as_cmpmov, $ad_fecdes, $ad_fechas, $as_tipcau, $as_coddes, $as_codhas, $ai_orden, $as_codrespri, $as_codresuso, $as_codubifis, $as_codsigecofdesde, $as_codsigecofhasta) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //    	 Description :   Funci�n que obtiene los datos maestros de un movimientos
        ...
        //	echo "---->".$as_coddes."<br>";
        //	echo "---->".$as_codhas."<br>";
        //	echo "---->".$as_codrespri."<br>";
        //	echo "---->".$as_codresuso."<br>";
        //	echo "---->".$as_codubifis."<br>";
        //	echo "---->".$as_codsigecofdesde."<br>";
        //	echo "---->".$as_codsigecofhasta."<br>";
        //die();
        ...
        }//Modificado por Jose Luis Aguilera Medina CTSI - OPSU
        //FILTRO RESPONSABLE PRIMARIO
        if (($as_codrespri != "")) {
            $ls_sqlint = $ls_sqlint . " AND saf_movimiento.codrespri = '" . $as_codrespri . "' ";
        }//Modificado por Jose Luis Aguilera Medina CTSI - OPSU
        //FILTRO RESPONSABLE DE USO
        if (($as_codresuso != "")) {
            $ls_sqlint = $ls_sqlint . " AND saf_movimiento.codresuso = '" . $as_codresuso . "' ";
        }//Modificado por Jose Luis Aguilera Medina CTSI - OPSU
        // FILTRO UNIDAD ADMINISTRATIVA
        if (($as_codubifis != "")) {
            $ls_sqlint = $ls_sqlint . " AND saf_movimiento.codubifis = '" . $as_codubifis . "' ";
        }//Modificado por Jose Luis Aguilera Medina CTSI - OPSU
        //FILTRO CODIGO SIGECOF
        if (($as_codsigecofdesde != "") && ($as_codsigecofhasta != "")) {
            $ls_sqlint = $ls_sqlint . " AND saf_activo.catalogo >= '" . $as_codsigecofdesde . "'" .
                    " AND saf_activo.catalogo <= '" . $as_codsigecofhasta . "' ";
        }//Modificado por Jose Luis Aguilera Medina CTSI - OPSU

        $ls_sql = "SELECT saf_movimiento.cmpmov,saf_movimiento.codcau,saf_movimiento.descmp,saf_movimiento.feccmp," .
                "	saf_causas.dencau,saf_movimiento.codusureg,saf_movimiento.codresuso,sno_personal.nomper," .
                "	sno_personal.apeper,saf_movimiento.codubifis," .
                "	(SELECT denuniadm FROM saf_unidadadministrativa
					WHERE saf_unidadadministrativa.coduniadm=saf_movimiento.codubifis) AS desubifis" .
                " FROM saf_movimiento,saf_causas,saf_dt_movimiento,sno_personal,saf_activo" .
                ...
                "	AND saf_movimiento.codresuso = sno_personal.codper" .
                " GROUP BY saf_movimiento.cmpmov,saf_movimiento.codcau,saf_movimiento.descmp,saf_causas.dencau," .
                "          saf_movimiento.feccmp,saf_movimiento.codusureg,saf_movimiento.codresuso,	sno_personal.nomper,
	sno_personal.apeper,saf_movimiento.codubifis";
...
// fin function uf_saf_load_movimiento
    ...
    function uf_saf_load_dt_movimiento($as_codemp, $as_cmpmov, $as_codcau) {
        ...
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene los detalles de un movimiento
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   09/06/2006						Fecha de Ultima Modificaci�n: 09/06/2006
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
// fin function uf_saf_load_dt_modificacion
    ...
    function uf_saf_load_activos($as_codemp, $ai_ordenact, $ad_desde, $ad_hasta, $as_coddesde, $as_codhasta, $as_status, $as_codrespri, $as_codresuso, $as_coduniadm, $as_codsigecofdesde, $as_codsigecofhasta) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //  			         $as_coduniadm // codigo de ubicación fisica del activo
        //	         Returns :   Retorna un Booleano
        ...
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   14/06/2006							Fecha de Ultima Modificaci�n:   07/11/2006
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        ...
        //MODIFICADO POR JOSÉ LUIS AGUILERA 06-11-2012
        if ((!empty($as_codsigecofdesde)) && (!empty($as_codsigecofhasta))) {
            $ls_sql = $ls_sql . " AND saf_activo.catalogo >='" . $as_codsigecofdesde . "'" .
                    " AND saf_activo.catalogo <='" . $as_codsigecofhasta . "'";
        }
        //FIN MODIFICACIÓN JLA
        ...
        if (!empty($as_coduniadm)) {    // Ubicación fisica del activo
            $ls_sql = $ls_sql . " AND saf_dta.codubifis='" . $as_coduniadm . "'";
        }
        if ($ai_ordenact == 0) {
            $ls_order = "codact";
        } else {
        ...
        if ($as_status == 1) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='R'";
        }
        if ($as_status == 2) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='I'";
        }
        if ($as_status == 3) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='A'";
        }
        if ($as_status == 4) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='M'";
        }
        if ($as_status == 5) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='C'";
        }
        if ($as_status == 6) {
            $ls_sql = $ls_sql . " AND saf_dta.estact='D'";
        }
    ...
    function uf_saf_load_activos_simple($as_codemp)
    {
        $lb_valido = false;
    ...
    function uf_saf_select_dt_activo($as_codemp, $as_codact, $as_status) { //,$as_coduniadm
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //	         Returns :  Retorna un Booleano
        //	      Description:  Funci�n que se encarga de obtener los detalles de un activo
        //         Creado por:  Ing. Luis Anibal Lang
        //   Fecha de Cracion:  14/06/2006							Fecha de Ultima Modificaci�n: 14/06/2006
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = true;
        $this->io_sql = new class_sql($this->con);
        $ls_sqlest = "";
        if ($as_status == 1) {
            $ls_sqlest = " AND saf_dta.estact='R'";
        }
        if ($as_status == 2) {
            $ls_sqlest = " AND saf_dta.estact='I'";
        }
        if ($as_status == 3) {
            $ls_sqlest = " AND saf_dta.estact='A'";
        }
        if ($as_status == 4) {
            $ls_sqlest = " AND saf_dta.estact='M'";
        }
        if ($as_status == 5) {
            $ls_sqlest = " AND saf_dta.estact='C'";
        }
        if ($as_status == 6) {
            $ls_sqlest = " AND saf_dta.estact='D'";
        }
...
//fin  function uf_saf_select_dt_activo
    ...
    function uf_saf_load_depactivos($as_codemp, $ai_ordenact, $as_coddesde, $as_codhasta) {
        ...
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   14/06/2006							Fecha de Ultima Modificaci�n:   15/06/2006
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        $ls_sqlcod = "";
        if ((!empty($as_coddesde)) && (!empty($as_codhasta))) {
...
//fin  function uf_saf_select_dt_depactivo
    ...
    function uf_saf_load_depmensual($as_codemp, $ai_ordenact, $ad_fecdep) {
        ...
        //	      Description:   Funcion que se encarga de obtener los datos para el reporte de depreciacion de activos fijos
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   07/08/2006							Fecha de Ultima Modificaci�n:   07/08/2006
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_saf_load_sigecof($as_codemp, $ai_ordenact, $as_coddesde, $as_codhasta) {
        ...
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   06/09/2006							Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        $ls_sqlint = "";
        $ls_sqlcod = "";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_saf_load_defactivos($as_codemp, $ai_ordenact, $ad_desde, $ad_hasta, $as_coddesde, $as_codhasta, $as_codrespri, $as_codresuso, $as_codsigecofdesde, $as_codsigecofhasta, $as_codsigefechadesde, $as_codsigefechahasta, $as_codubifis) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //   Fecha de Cracion:   25/09/2006							Fecha de Ultima Modificaci�n: 03/09/2007
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        $ls_sqlint = "";
        if ((!empty($as_coddesde)) && (!empty($as_codhasta))) {
        ...
        //MODIFICADO POR JOSÉ LUIS AGUILERA 06-11-2012/ 11-07-2013
        if ((!empty($as_codsigecofdesde)) && (!empty($as_codsigecofhasta))) {
            $ls_sqlint = $ls_sqlint . " AND saf_activo.catalogo >='" . $as_codsigecofdesde . "'" .
                    " AND saf_activo.catalogo <='" . $as_codsigecofhasta . "'";
        }
        if ($ai_ordenact == 0) {
            $ls_order = "saf_dta.codact,saf_activo.denact,saf_activo.maract,saf_activo.modact,saf_activo.catalogo,
						saf_activo.costo,saf_activo.feccmpact,saf_dta.estact,saf_dta.codres,nomres,	aperes,
						saf_dta.codrespri,nomrespri,aperespri,saf_dta.idchapa,saf_dta.codubifis,a.denuniadm,
						dtmov.cmpmov ";
        } else {
            $ls_order = "saf_activo.denact,saf_dta.codact,saf_activo.maract,saf_activo.modact,saf_activo.catalogo,
						saf_activo.costo,saf_activo.feccmpact,saf_dta.estact,saf_dta.codres,nomres,aperes,
						saf_dta.codrespri,nomrespri,aperespri,saf_dta.idchapa,saf_dta.codubifis,a.denuniadm,
						dtmov.cmpmov ";
        }
        ...
        if (!empty($as_codubifis)) {
            $ls_sqlint = $ls_sqlint . " AND saf_dta.codubifis='" . $as_codubifis . "'";
        }



        $ls_sql = "SELECT	distinct saf_dta.codact,saf_activo.denact,saf_activo.maract,saf_activo.modact,saf_activo.catalogo," .
                "		saf_activo.costo,saf_activo.feccmpact,saf_dta.estact,saf_dta.codres," .
                ...
                "		saf_dta.codrespri," .
                "		(SELECT nomper FROM sno_personal WHERE saf_dta.codrespri=sno_personal.codper) AS nomrespri," .
                "		(SELECT apeper FROM sno_personal WHERE saf_dta.codrespri=sno_personal.codper) AS aperespri, " .
                "		saf_dta.idchapa,saf_dta.codubifis,a.denuniadm,dtmov.cmpmov " .
                "FROM 	saf_dta" .
                "		LEFT JOIN saf_activo ON (saf_dta.codact = saf_activo.codact )	" .
                "		LEFT JOIN saf_unidadadministrativa a ON (a.coduniadm=saf_dta.codubifis)" .
                "		LEFT JOIN  saf_dt_movimiento dtmov ON(dtmov.ideact=saf_dta.ideact)" .
                " WHERE  saf_activo.codemp='" . $as_codemp . "'  AND " .
                "        saf_dta.codemp=saf_activo.codemp    " . $ls_sqlint .
                " ORDER BY " . $ls_order . "";
//echo"$ls_sql";die();
        /* /Original
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function uf_saf_load_unidadadministrativas($as_codemp, $as_coduniadm, &$as_denuniadm) {
        ...
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   26/09/2006							Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function uf_saf_load_dt_compreasignacion($as_codemp, $as_cmpmov, $as_codrespri, $as_codresuso) {
        ...
        //    	 Description :   Funci�n que obtiene los detalles de un movimiento
        //         Creado por:   Ing. Luis Anibal Lang
        //   Fecha de Cracion:   28/09/2006						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        $ls_int = "";
        $this->io_sql = new class_sql($this->con);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene los comprobantes de desincoprporacion por concepto de
        //                       Bienes Muebles faltantes (060)
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   13/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //  			         ad_anno       // A�o de la generacion de los movimientos
        ...
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene el detalle de los comprobantes de desincoprporacion por concepto de
        //                       Bienes Muebles faltantes (060)
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   12/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene los totales de incorporaciones y desincorporaciones de bienes en el mes y a�o    //                        indicado
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   11/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //                       as_codhasta   // Codigo del Activo Final
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene el detalle de las desincorporaciones en el mes excepto el 060
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   10/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //                       as_codhasta   // Codigo del Activo Final
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene el detalle de las desincorporaciones con causa 060
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   04/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //                       as_codhasta   // Codigo del Activo Final
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene el detalle de las incorporaciones en el mes
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:   04/12/2007					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//                       	as_sec        // Codigo de la Seccion
//	         Returns :   Retorna un Booleano
//    	     Description :   Funci�n que obtiene los detalles de los movimientos de los bienes muebles
//             Creado por:   Ing. Arnaldo Su�rez
//       Fecha de Cracion:   04/12/2007					Fecha de Ultima Modificaci�n:
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que obtiene el detalle de la Cuenta de Bienes Muebles por Unidad Administrativa
        //         Creado por:   Ing. Arnaldo Su�rez
        //   Fecha de Cracion:  02/01/2008					Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function uf_select_inventario_unidad($coduniadmi, $fecha1, $fecha2, $estatus, $orden, $cod1, $cod2, $grupo, $subgrupo, $seccion) {
        ...
        $ls_sql = "SELECT saf_dta.codact,MAX(saf_activo.codgru) AS codgru, MAX(saf_activo.codsubgru) as codsubgru, MAX(saf_activo.codsec) AS codsec, MAX(saf_activo.codemp) as codemp," .
                ...
                " GROUP BY saf_dta.codact,saf_dta.ideact";
        $ls_orden;
...
////-------------------------------------------------------------------------------------------------------------------------------
////////////////////funcion para mostrar tipo de adquisici�n de bienes/////////////////////////////////////////////////
///////////////////creado por la Ing. Jennifer Rivero/////////////////////////////////////////////////////////////////////////7
...
////-------------------------------------------------------------------------------------------------------------------------------
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////funci�n que selecciona al proveedor de un bien///////////////////////////////////////////////////////////////////
...
////-------------------------------------------------------------------------------------------------------------------------------
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////funci�n que selecciona al proveedor y la unidad Administrativa de un bien///////////////////////////////////////////////////////////////////
////////////creado por la Ing. Jennifer Rivero //////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////-------------------------------------------------------------------------------------------------------------------------------
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////funci�n que selecciona el comprobante de movimiento de un bien///////////////////////////////////////////////////////////////////
////////////creado por la Ing. Jennifer Rivero //////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_saf_load_bienes_uniadm($as_codemp, $ai_ordenact, $as_coddesde, $as_codhasta, $as_coduniadmdesde, $as_coduniadmhasta) {
        ...
        //   Fecha de Cracion: 25/06/2008						Fecha de Ultima Modificaci�n: 	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//fin uf_saf_load_bienes_uniadm
    ...
    function uf_saf_buscar_prestamo($as_codemp, $as_cmpres, $as_coduniadmcede, $as_coduniadmrece, $ad_fecenacta, $as_codresced, $as_codreserec, $as_codper) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //	         Function:   uf_saf_buscar_prestamo
        //	           Access:   public
        //  		Arguments:   as_codemp     // c�digo de empresa
        //  			         as_cmpres     // comprobante de pr�stamo
	...
	//	         Returns :   Retorna un Booleano
        ...
        //   Fecha de Cracion:   24/04/2008						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
// fin function uf_saf_buscar_prestamo
    ...
    function uf_saf_buscarcargos_reponcedente($as_codemp, $as_cmpres, $as_codresced) {
        ...
        //
	//	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que la c�dula y el cargo del reponsable cedente
        //         Creado por:   Ing.Gloriely Fr�itez
        //   Fecha de Cracion:   24/04/2008						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
// fin function  uf_saf_buscarcargos_reponcedente
    ...
    function uf_saf_buscarcargos_reponreceptor($as_codemp, $as_cmpres, $as_codreserec) {
        ...
        //  		Arguments:   as_codemp     // c�digo de empresa
        //  			         as_cmpres     // comprobante de pr�stamo
        //                       as_codresrec     // c�digo del responsable de la unidad receptor
        //
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que la c�dula y el cargo del reponsable receptor
        //         Creado por:   Ing.Gloriely Fr�itez
        //   Fecha de Cracion:   24/04/2008						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
// fin function  uf_saf_buscarcargos_reponreceptor
    ...
    function uf_saf_buscarcargos_repontestigo($as_codemp, $as_cmpres, $as_codper) {
        ...
        //
        //	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que la c�dula y el cargo del testigo.
        //         Creado por:   Ing.Gloriely Fr�itez
        //   Fecha de Cracion:   24/04/2008						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
...
// fin function  uf_saf_buscarcargos_reponreceptor
    ...
    function uf_saf_buscar_autorizacion($as_codemp, $as_cmpsal, $as_coduniadmcede, $ad_fechauto, $as_codprov, $as_cedrepre, $as_concepto, $ad_fecent, $ad_fecdevo, $as_obser) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //	         Function:   uf_saf_buscar_autorizaci�n
        //	           Access:   public
        //  		Arguments:   as_codemp     // c�digo de empresa
        //  			         as_cmpsal     // n�mero de la autorizaci�n
        //  			         as_coduniadmcede  // c�digo de la unidad cedente
        //  			         ad_fechauto   // fecha de al autorizaci�n
        //                       as_codprov     // c�digo del proveedor
        //                       as_cedrepre     // c�dula del responsable de la empresa quien recibe
        //                       as_concepto    // concepto de la autorizaci�n
        //                       ad_fecent        // fecha de entrega
        //                       ad_fecent       // fecha de entrega
        //                       ad_fecent       // observaci�n de la autorizaci�n
        //
	//	         Returns :   Retorna un Booleano
        //    	 Description :   Funci�n que busca los datos de la autorizaci�n
        //         Creado por:   Ing.Gloriely Fr�itez
        //   Fecha de Cracion:   30/04/2008						Fecha de Ultima Modificaci�n:
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lb_valido = false;
        ...
        $li_numrows = $this->io_sql->num_rows($rs_data);
        if ($rs_data === false) {
            $this->io_msg->message("CLASE->Report MÉTODO->uf_saf_buscar_autorizaci�n ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
        } else {
            if ($li_numrows > 0) {
                $data = $this->io_sql->obtener_datos($rs_data);
                $this->ds_detalle->data = $this->io_sql->obtener_datos($rs_data);
...
// fin function uf_saf_buscar_autorizaci�n
...
//fin  function uf_saf_load_dt_cmpentrega
    ...
    function uf_saf_buscar_registroaux($as_codemp, $as_codsigecof, $as_orden, $ad_desde, $as_hasta, $as_codactdes, $as_codhasta, $as_codresuso) {
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// fin function uf_saf_buscar_registroaux
    ...
    function uf_load_data_institucion() {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //	   Function: uf_retornar_activo
        //         Access: public
        //      Argumento: $as_numcmp = N�mero del Comprobante de Autorizacion de Salida/Acta de Prestamo.  //
        //      Description:  Este m?odo realiza una b?squeda del C?igo de Empresa 0001 dentro de la
        //	    Returns: $lb_valido = Variable booleana que devuelve true si todo se ejecuta correctamente, false de lo contrario.
        //	 Creado Por: Ing. Johan Rujano
        // Fecha Creaci?: 09/10/2014
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////



        $lb_existe = false;
        $ls_sql = " SELECT * FROM sigesp_empresa WHERE codemp='0001' ";
        $rs_data = $this->io_sql->select($ls_sql);
        if ($rs_data === false) {
            $lb_valido = false;
            $this->io_msg->message("CLASE->sigesp_saf_class_report.php->M?ODO->uf_load_data_institucion.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
        }
    ...
    function uf_load_data_autoridad() {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //	   Function: uf_retornar_activo
        //         Access: public
        //      Argumento: $as_numcmp = N�mero del Comprobante de Autorizacion de Salida/Acta de Prestamo.  //
        ...
        $lb_existe = false;
        $ls_sql = " SELECT
                        sigesp_autoridad.codemp,sigesp_autoridad.codauto,sigesp_autoridad.cedauto,sigesp_autoridad.nomauto,
                        sigesp_autoridad.apeauto,sigesp_autoridad.cargoauto,sigesp_autoridad.telauto,sigesp_autoridad.celauto,
                        sigesp_autoridad.email,sigesp_autoridad.nrogaceta,sigesp_autoridad.fecgaceta,sigesp_autoridad.resauto,
                        sigesp_autoridad.fecresolucion,sigesp_autoridad.estautoridad,sigesp_autoridad.fecfinejercicio,
                        sigesp_empresa.codsudebip,sigesp_empresa.rifemp
                        FROM
                        sigesp_autoridad
                        INNER JOIN sigesp_empresa ON sigesp_autoridad.codemp = sigesp_empresa.codemp
                        WHERE sigesp_autoridad.estautoridad='1'";
        $rs_data = $this->io_sql->select($ls_sql);
        if ($rs_data === false) {
            $lb_valido = false;
            $this->io_msg->message("CLASE->sigesp_saf_class_report.php->M?ODO->uf_load_data_autoridad.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
        }

        return $rs_data;
    }

    function uf_load_data_sede($as_sede) {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //	   Function: uf_retornar_activo
        //         Access: public
        //      Argumento: $as_numcmp = N�mero del Comprobante de Autorizacion de Salida/Acta de Prestamo.  //
        ...
        $ls_sql = "SELECT saf_sede.codemp,saf_sede.codsede,saf_sede.tipsede,saf_sede.descripcion, saf_sede.localizacion, saf_sede.cod_pais,saf_sede.cod_estado, ".
               " saf_sede.cod_municipio, saf_sede.cod_ciudad_localidad, saf_sede.cod_parroquia, saf_sede.urbanizacion, saf_sede.casa, saf_sede.calle, ".
               " saf_sede.piso, saf_ciudades_localidades.descripcion AS ciudad, sigesp_empresa.nombre,sigesp_empresa.feclicemp, sigesp_empresa.codsudebip,".
               " sigesp_empresa.nitemp, sigesp_empresa.rifemp FROM saf_sede ".
               " INNER JOIN sigesp_empresa ON saf_sede.codemp = sigesp_empresa.codemp ".
               " INNER JOIN saf_ciudades_localidades ON saf_sede.cod_ciudad_localidad = saf_ciudades_localidades.cod_ciudad_localidad".
               "  WHERE codsede='".$as_sede."' ";


        $rs_data = $this->io_sql->select($ls_sql);
        if ($rs_data === false) {
            $lb_valido = false;
            $this->io_msg->message("CLASE->sigesp_saf_class_report.php->M?ODO->uf_load_data_sede.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
        }
     ...
     *
     */
    function uf_load_data_proveedores() {
    	$lb_existe = false;
    	$ls_sql = "SELECT DISTINCT rpc_proveedor.cod_pro,rpc_proveedor.nompro,CASE WHEN rpc_proveedor.codpai= '000296' THEN 'N' ELSE 'I' END,rpc_proveedor.rifpro,rpc_proveedor.telpro
                    FROM rpc_proveedor
                    INNER JOIN soc_ordencompra
                    ON rpc_proveedor.cod_pro=soc_ordencompra.cod_pro
                    WHERE soc_ordencompra.estcondat = 'B'
    	...
    	if ($rs_data === false) {
    		$lb_valido = false;
    		$this->io_msg->message("CLASE->sigesp_saf_class_report.php->M?ODO->uf_load_data_proveedores.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
    	} else {
    		if ($li_numrows > 0) {
    			//$data = $this->io_sql->obtener_datos($rs_data);
    ...
    function uf_load_data_origenes_a() {
    	$lb_existe = false;
    	$ls_sql = "SELECT * FROM saf_activo WHERE cod_aquisicion = 1";
    	$rs_data = $this->io_sql->select($ls_sql);
    	//print_r($rs_data);
    	$li_numrows = $this->io_sql->num_rows($rs_data);
    	if ($rs_data === false) {
    		$lb_valido = false;
    		$this->io_msg->message("CLASE->sigesp_saf_class_report.php->M?ODO->uf_load_data_origenes.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
    	} else {
    		if ($li_numrows > 0) {
    			//$data = $this->io_sql->obtener_datos($rs_data);
    			$data = $this->io_sql->obtener_asso($rs_data);
    ...
    function uf_load_data_seguro() {
        $lb_existe = false;
        $ls_sql = "SELECT codact,companiaase,numpolase,tipopolase,montocobase,monedaase,";
        $ls_sql .= "fechainiase,fechafinase,respcivase,tipocobase,descobase";
        $ls_sql .= " FROM saf_activo_seguro";
        $rs_data = $this->io_sql->select($ls_sql);
        //print_r($rs_data);
        $li_numrows = $this->io_sql->num_rows($rs_data);
        if ($rs_data === false) {
            $lb_valido = false;
            $this->io_msg->message("CLASE->sigesp_saf_class_report.php->MEODO->uf_load_data_origenes.ERROR->" . $this->io_funcion->uf_convertirmsg($this->io_sql->message));
        } else {
            if ($li_numrows > 0) {
                //$data = $this->io_sql->obtener_datos($rs_data);
                $data = $this->io_sql->obtener_asso($rs_data);
    ...
    function uf_load_data_responsable() {
        $lb_existe = false;
        $ls_sql = "SELECT DISTINCT (saf_dta.codemp || saf_dta.codres) AS codinterno,";
        $ls_sql .= "'tipo',codres,sno_personal.cedper,sno_personal.nomper,sno_personal.apeper,sno_personal.telmovper,";
        $ls_sql .= "'cargo' AS cargo,(sno_personal.codusu || '@opsu.gob.ve') AS  email,'dependencia' AS dependencia";
        $ls_sql .= " FROM saf_dta";
        $ls_sql .= " INNER JOIN sno_personal";
        $ls_sql .= " ON saf_dta.codres = sno_personal.codper";
        $ls_sql .= " ORDER BY codinterno ASC";
        $rs_data = $this->io_sql->select($ls_sql);
        //print_r($rs_data);
        $li_numrows = $this->io_sql->num_rows($rs_data);
        if ($rs_data === false) {
