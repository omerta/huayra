<?php
	class sigesp_c_seguridad
	{
		...
		/**
		 * Funcion que inserta un evento que se origina en alguna operación
		 * de INSERT, UPDATE o DELETE dentro del Sistema y lo inserta en la
		 * tabla sss_registro_eventos.
		 *
		 * @param string $as_empresa Código de Empresa
		 * @param string $as_sistema Código de Sistema
		 * @param string $as_evento Código de Evento
		 * @param string $as_usuario Código de Usuario
		 * @param string $as_ventana Código de Ventana
		 * @param string $as_descripcion Código de Evento
	   ...
	   * Funcion que verifica si un usuario tiene permiso en determinada pantalla
		...
		*/
		function uf_sss_load_permisos($as_empresa,$as_usuario,$as_sistema,$as_ventana,&$aa_permisos)
		{
			...
			{
				/* No lleva ninguna acci�n ya el llenado de los permisos viene del metodo load_permisos_por_grupo,
	   ...
	   * @param string $as_empresa   Código de empresa
		 ...
		 * @param string $as_sistema   Código de sistema
		 * @param string $as_ventana   Código de ventana
		 * @param string $as_codintper Código interno de permisologia
		 * @param string $aa_permisos  Córeglo que contiene los permisos de la barra de herramienta
		 *
