 ...
 class class_funciones
 {
  ...
  function uf_convertirfecmostrar($as_fecha)
  {
   ...
   function uf_trim($cadena)
   {
    ...
    /**
    * Funcion uf_convertirmsg($as_mensaje), convierte una tira de catracteres en
    * mensaje visual.
    *
    * @param string $as_mensaje
    */
  	function uf_convertirmsg($as_mensaje)
  	{
      $ls_mensaje=str_replace("\r", '', (string)$as_mensaje);
      $ls_mensaje=addcslashes($ls_mensaje,"\0..\37'\\");
