...
//		$li_totrow=$io_report->ds_solicitud->getRowCount("numsolvia");
		...
		$tbHtml = "<table>
             <header>
                <tr>
                  <th>Solicitud</th>
                  <th>Cédula</th>
                  <th>Nombre PErsonal/Beneficiario</th>
                  <th>Fecha Salida</th>
                  <th>Fecha Retorno</th>
                  <th>Ruta</th>
                  <th>Monto Bs</th>
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$tbHtml .= "<tr><td>".$la_data[$li_i]['numsolvia']."</td>
						<td>".$la_data[$li_i]['cedula']."</td>
						<td>".$la_data[$li_i]['nombre']."</td>
						<td>".$la_data[$li_i]['fecsalvia']."</td>
						<td>".$la_data[$li_i]['fecregvia']."</td>
						<td>".$la_data[$li_i]['desrut']."</td>
						<td>".$li_monto."</td>
						";
		...
		header("Content-Disposition: attachment; filename=listadoviatico.xls");
