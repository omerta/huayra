...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function uf_sss_select_eventos($as_evento,&$ls_descripcion)
		{
			...
			if($li_exec<=0)
			{
				$this->is_msg_error = "Error en m�todo uf_sss_verificar_evento  ";
				$lb_valido=false;
			}
			else
			{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		function uf_sss_insert_eventos_ventana($as_empresa,$as_sistema,$as_evento,$as_usuario,$as_ventana)
		{
			...
			if($li_exec<=0)
			{
				...
				$this->is_msg_error = "Error en m�todo uf_sss_insert_derecho_usuario  ";
				$lb_valido=false;
		...
		/**
		 * Función uf_sss_select_permisos()
		 *
		 * @param $as_empresa
		 * @param $as_usuario
		 * @param $as_sistema
		...
		function uf_sss_select_permisos($as_empresa,$as_usuario,$as_sistema,$as_ventana)
		{
			...
			$ls_sql = " WHERE codemp='".$as_empresa."' AND codusu='".$as_usuario."' AND codsis='".$as_sistema."' AND nomven='".$as_ventana."' AND enabled=".$ls_enabled." ";
			$li_exec=$this->SQL->select($ls_sql);
			...
			{
				$io_msg->message("UD. no tiene permiso para accesar a esta opci�n de menu");
				$lb_valido=false;
				$this->is_msg_error = "Error en m�todo uf_sss_select_derecho_usuario ";
			}
			return $lb_valido;
			$this->SQL->free_result($li_exec);
		}
