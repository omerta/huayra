...
if ($ape!=""){
	...
	if($emp_transferencia!=""){
	    ...
	    $lobjPdf->Ln();
	        ...
	        $lobjPdf->SetFont('Arial', '', 12);
	        $lobjPdf->WriteFlowingBlock(utf8_decode(" titular de la cédula de identidad Nro v-12.368.356, en mi carácter de "));
	        $lobjPdf->SetFont('Arial', 'B', 12);
	        $lobjPdf->WriteFlowingBlock("Gerente General de la Empresa Mixta Socialista Arroz del ALBA S.A,");
	        $lobjPdf->SetFont('Arial', '', 12);
    ...
    $lobjPdf->setX(20);
    $lobjPdf->Cell(175,7,utf8_decode("Ing. Antonio Tirado "),0,1,"C");
    $lobjPdf->setX(20);
