<?php
	...
	else  // Imprimimos el reporte
	{
		...
		//codigo nuevo ps
		$tbHtml .= "<tr><td>".$la_data[$li_i]['nro']."</td>
						<td>".$la_data[$li_i]['cedula']."</td>
						<td>".$la_data[$li_i]['nombre']."</td>
						<td>".$la_data[$li_i]['personal']."</td>
						<td>".$la_data[$li_i]['patron']."</td>
						<td>".$la_data[$li_i]['total']."</td></tr>";
		}
		$tbHtml .= "</html>";
		header("Content-type: application/octet-stream");
		header("Content-Disposition: attachment; filename=cajaahorro.xls");
