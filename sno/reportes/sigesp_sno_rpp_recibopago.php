<?PHP
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_seguridad($as_titulo,$as_titrepnom,$as_periodo,$ai_tipo)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_insert_seguridad
		//		   Access: private 
		//	    Arguments: as_titulo // Arreglo de las variables de seguridad
		//	    		   as_titrepnom // Arreglo de las variables de seguridad
		...
		$ls_descripcion="Generó el Reporte ".$as_titulo.". Para ".$as_titrepnom.". ".$as_periodo;
		if($ai_tipo==1)
		{
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina1($as_titulo,$as_titrepnom,$as_periodo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina1
		//		   Access: private 
		//	    Arguments: as_titulo // Título del Reporte
		//	    		   as_titrepnom // Descripción de la nómina
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_titrepnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,705,9,$as_titrepnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina2($as_titulo,$as_titrepnom,$as_periodo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_titrepnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,315,9,$as_titrepnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	$ls_titulo1="<b>NOMINA DE EMPLEADO</b>";
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo,$ls_titrepnom,$ls_periodo,$li_tipo); // Seguridad de Reporte
	if($lb_valido)
	{
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina1($ls_titulo,$ls_titrepnom,$ls_periodo,$io_pdf); // Imprimimos el encabezado de la página
		uf_print_encabezado_pagina2($ls_titulo,$ls_titrepnom,$ls_periodo,$io_pdf); // Imprimimos el encabezado de la página
