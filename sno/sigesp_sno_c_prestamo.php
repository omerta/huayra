...
class sigesp_sno_c_prestamo
{
    ...
    function uf_select_prestamo($as_campo,$as_valor)
    {
		...
		//	  Description: Funcion que valida que ning�n prestamo tenga asociada este pesonal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		//////////////////////////////////////////////////////////////////////////////
 		$lb_existe=false;
       	...
       	if ($rs_data===false)
       	{
        	$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_select_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
       	}
       	else
       	{
	...
	function uf_load_correlativo(&$ai_numpre)
	{
		...
		//      Arguments: ai_numpre  // Nuevo n�mero de prestamo
		//	      Returns: lb_valido True si se ejecut� correctamente � False si hubo alg�n error
		//	  Description: Funcion que busca el correlativo del �ltimo prestamo  y genera el nuevo correlativo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_numpre=1;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_load_correlativo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
								...
								$aa_seguridad)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_insert_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	...
	function uf_load_ultimoperiodo(&$as_ultpernom)
	{
		...
		//	    Arguments: as_ultpernom  // �ltimo per�odo de la N�mina
		//	      Returns: lb_valido True si se obtiene el �ltimo per�odo de la n�mina sin problema False si hubo error
		//	  Description: Funcion que obtiene el �ltimo per�odo de la n�mina actual
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_load_ultimoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_incremento()
	{
		...
		//	      Returns: ai_incremento  // Incremento de la n�mina si es semanal, quincenal, mensual � anual
		//	  Description: funci�n que obtiene el tipo de n�mina y determina el incremento
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 13/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ai_incremento=0;
	...
	function uf_incrementar_periodo($ai_tippernom,$ai_incremento,$as_tipcuopre,&$as_percob,&$ad_feciniper,&$ad_fecfinper)
	{
		...
		//		   Access: private (uf_generar_cuotas,uf_prestamorecalcular,uf_prestamosuspender)
		//	    Arguments: ai_tippernom  // Tipo de Per�odo de la n�mina (Semanal, Quincenal, Mensual, Anual)
		//	    		   ai_incremento  // Cantidad en cuanto se van a incrementar los d�as del per�odo
		//	    		   as_percob  // Per�odo
		//	    		   ad_feciniper  // Fecha de Inicio del Per�odo
		//	    		   ad_fecfinper  // Fecha de Finalizaci�n del Per�odo
		//	      Returns: ai_incremento  // Incremento de la n�mina si es semanal, quincenal, mensual � anual
		//	  Description: funci�n que incrementa el per�do, la Fecha de inicio del per�odo y la fecha fin del per�odo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 13/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
							  ...
							  $ad_fechasper,$ai_sueper,$ai_moncuo,$as_configuracion,$as_tipcuopre,$aa_seguridad)
	{
		...
		//				   ai_sueper  // sueldo del personal
		//				   ai_moncuo  // Monto de la cuota mensual
		//				   as_configuracion  // Configuraci�n de la cuota
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el insert � False si hubo error en el insert
		//	  Description: Funci�n que genera las cuotas del prestamo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
						...
						$ai_monamopre,$ad_fecdesper,$ad_fechasper,$ai_sueper,$ai_moncuo,$as_configuracion,$as_tipcuopre,$aa_seguridad)
	{
		...
		//				   ai_sueper  // sueldo del personal
		//				   ai_moncuo  // Monto de la cuota mensual
		//				   as_configuracion  // Configuraci�n del prestamo si es por monto � por cuotas
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el guardar � False si hubo error en el guardar
		//	  Description: funci�n que guarda el prestamo del personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		...
		$ai_moncuo=str_replace(",",".",$ai_moncuo);
		$ls_prestamo="0";
		$ls_prestamo=$this->uf_select_config("SNO","CONFIG","VAL_TIPO_PRESTAMO",$ls_prestamo,"I");//configuraci�n para el prestamo
		switch ($as_existe)
		{
			case "FALSE":
        ...
        if (!$this->io_cuota->uf_existe_cuotapagada($as_codper,$as_codtippre,$ai_numpre))
		{
			...
			if($lb_valido)
			{
				...
				if($li_row===false)
				{
					$lb_valido=false;
					$this->io_sql->rollback();
					$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_delete ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				}
				else
				{
					/////////////////////////////////         SEGURIDAD               /////////////////////////////
					$ls_evento="DELETE";
					$ls_descripcion ="Elimin� el prestamo ".$ai_numpre." de tipo ".$as_codtippre." del personal ".
									 "".$as_codper." asociado a la n�mina ".$this->ls_codnom;
					$lb_valido=$this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
													$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
													$aa_seguridad["ventanas"],$ls_descripcion);
    ...
    function uf_update_nrocuota_prestamo($as_codper,$as_codtippre,$ai_numpre,$ai_numcuopre,$aa_seguridad)
    {
		...
		//				   as_codtippre  // C�digo del tipo de Prestamo
		//				   ai_numpre  // N�mero Correlativo del Prestamo
		//				   ai_numcuopre  // N�mero de cuotas en que se va a cancelar el prestamo
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si realiz� el update � False si no lo actualiz�
		//	  Description: Funci�n que actualiza las cuotas en que se va a pagar un prestamo debido a un recalculo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 09/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 		$lb_valido=false;
		...
		$li_row=$this->io_sql->execute($ls_sql);
       	if ($li_row===false)
       	{
        	$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_nrocuota_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
       	}
       	else
       	{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� el n�mero de cuotas del prestamo ".$ai_numpre." de tipo ".$as_codtippre." del personal ".
							 "".$as_codper." asociado a la n�mina ".$this->ls_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
    ...
    function uf_update_monto_prestamo($as_codper,$as_codtippre,$ai_numpre,$ai_monpre,$aa_seguridad)
    {
		...
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si realiz� el update � False si no lo actualiz�
		//	  Description: Funci�n que actualiza el monto del prestamo y su saldo actual
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 23/08/2008 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 		$lb_valido=false;
       	$ls_sql="UPDATE sno_prestamos ".
		...
		$li_row=$this->io_sql->execute($ls_sql);
       	if ($li_row===false)
       	{
        	$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_monto_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
       	}
       	else
       	{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
    ...
    function uf_update_observacion_prestamo($as_codper,$as_codtippre,$ai_numpre,$as_campo,$as_observacion,$aa_seguridad)
    {
		...
		//				   as_codtippre  // C�digo del tipo de Prestamo
		//				   ai_numpre  // N�mero Correlativo del Prestamo
		//				   as_campo  // Campo de _Observacion que se va a actualizar si es por recalcular � por suspender
		//				   as_observacion  // N�mero de cuotas en que se va a cancelar el prestamo
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si realiz� el update � False si no lo actualiz�
		//	  Description: Funci�n que actualiza las cuotas en que se va a pagar un prestamo debido a un recalculo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 11/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 		$lb_valido=false;
       	$ls_sql="UPDATE sno_prestamos ".
		...
		$li_row=$this->io_sql->execute($ls_sql);
       	if ($li_row===false)
       	{
        	$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_observacion_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
       	}
       	else
       	{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� la observaci�n ".$as_campo." del prestamo ".$ai_numpre." de tipo ".$as_codtippre." del personal ".
							 "".$as_codper." asociado a la n�mina ".$this->ls_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
					   		  ...
					   		  &$ai_cuofal,&$as_tipcuopre)
	{
		...
		//				   as_destippre  // Descripci�n del Tipo de Prestamo
		//				   as_codconc  // C�digo de concepto
		//				   as_nomcon  // Nombre de Concepto
		//				   ai_stapre  // Estatus del Prestamo
		//				   ai_monpre  // Monto del Prestamo
		//				   ai_numcuopre  // N�mero de Cuotas del Prestamo
		...
		//				   ad_fecdesper  // Fecha desde del per�odo
		//				   ad_fechasper  // Fecha Hasta del Per�odo
		//				   ai_sueper  // sueldo del personal
		//				   ai_cuofal  // cuotas faltantes
		//	      Returns: lb_valido True si se ejecuto el select � False si hubo error en el select
		//	  Description: Funci�n que obtiene la informaci�n del prestamo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 10/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
        	$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_load_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_select_resumen($as_codper,$as_codconc)
	{
		...
		//	  Description: Funcion que busca en la tabla de salidas si ya se calcul� este prestamo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 13/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_select_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
								   ...
								   $ai_salactpre,$as_obsrecpre,$ai_numcuopre,$as_configuracion,$as_tipcuopre,$aa_seguridad)
	{
		...
		//				   as_codtippre  // C�digo del tipo de Prestamo
		//				   ai_numpre  // N�mero Correlativo del Prestamo
		//				   ai_numcuofalpre  // N�mero de Cuotas faltantes
		//				   ai_nuemoncuopre  // Monto de las cuotas del prestamo
		//				   ai_sueper  // sueldo del personal
		//				   ai_cuopag  // Cuotas que han sido canceladas
		//				   ai_salactpre  // Saldo actual del Prestamo
		//				   as_obsrecpre  // Observaci�n de recalculo de las cuotas
		//				   ai_numcuopre  // N�mero Inicial de Cuotas del Prestamo
		//				   as_configuracion  // Configuraci�n si es por monto � por cuota
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el recalcular � False si hubo error en el recalcular
		//	  Description: funci�n que recalcula las cuotas del prestamo del personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 09/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			for($li_i=($li_numpricuo+1);$li_i<=$li_numultcuo;++$li_i)// Recorro las cuotas que ya est� generadas y les actualizo el monto
			{
				$li_cuota=$li_i;
				if(($li_totcuo<=$ai_numcuopre)&&($li_i==$li_numultcuo))// Si voy a actualizar las y es la �ltima que se va a generar
				{
					$ai_nuemoncuopre = ($ai_salactpre - ($ai_nuemoncuopre*($ai_numcuofalpre-1)));
				}
				$lb_valido=$this->io_cuota->uf_update_cuota($as_codper,$as_codtippre,$ai_numpre,$li_cuota,"","","",$ai_nuemoncuopre,"2",$aa_seguridad);
			}
			for($li_i=($li_numultcuo+1);$li_i<=$li_cuofin;++$li_i)// Recorro las restantes bien sea que generarlas � para eliminarlas
			{
				$li_cuota=$li_i;
				if($li_totcuo>=$ai_numcuopre)// Si necesito generar mas cuotas
				{
					...
					if($li_i==$li_cuofin)// S� es la �ltima cuota
					{
						$ai_nuemoncuopre = ($ai_salactpre - ($ai_nuemoncuopre*($ai_numcuofalpre-1)));
					}
								  ...
								  $ad_fecdes2,$ad_fechas2,$as_obssuspre,$as_tipcuopre,$aa_seguridad)
	{
		...
		//				   as_codtippre  // C�digo del tipo de Prestamo
		//				   ai_numpre  // N�mero Correlativo del Prestamo
		//				   as_perdes  // Per�odo desde que se va a suspender el prestamo
		//				   ad_fecdes1  // Fecha desde del periodo Desde
		//				   ad_fechas1  // Fecha hasta del Per�ode Desde
		//				   as_perhas  // Per�odo hasta que se va a suspender el prestamo
		//				   ad_fecdes2  // Fecha desde del periodo Hasta
		//				   ad_fechas2  // Fecha hasta del periodo Hasta
		//				   as_obssuspre  // Observaci�n por medio del cual se va a suspender un prestamo
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el recalcular � False si hubo error en el recalcular
		//	  Description: funci�n que suspende un prestado desde un per�odo hasta otro per�odo y le modifica los per�odos a las cuotas
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 10/02/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("No hay cuotas para el Per�odo Inicial seleccionado.");
			}
		}
		if($lb_valido)
		{
								   ...
								   $ai_salactpre,$as_obsrecpre,$ai_numcuopre,$as_configuracion,$as_tipcuopre,$ai_nuemonpre,$aa_seguridad)
	{
		...
		//				   as_configuracion  // Configuraci�n si es por monto � por cuota
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el refinanciar � False si hubo error en el refinanciar
		//	  Description: funci�n que refinancia el monto del prestamo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 23/08/2008 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			for($li_i=($li_numpricuo+1);($li_i<=$li_numultcuo)&&$lb_valido;++$li_i)// Recorro las cuotas que ya est� generadas y les actualizo el monto
			{
				$li_cuota=$li_i;
				if(($li_totcuo<=$ai_numcuopre)&&($li_i==$li_numultcuo))// Si voy a actualizar las y es la �ltima que se va a generar
				{
			...
			for($li_i=($li_numultcuo+1);($li_i<=$li_cuofin)&&$lb_valido;++$li_i)// Recorro las restantes bien sea que generarlas � para eliminarlas
			{
				$li_cuota=$li_i;
				if($li_totcuo>=$ai_numcuopre)// Si necesito generar mas cuotas
				{
	...
	function uf_select_salida($as_codper,$as_codconc,$as_tipsal)
	{
		...
		// Fecha Creaci�n: 01/02/2006 								Fecha �ltima Modificaci�n : 14/02/2006
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_peractnom=$_SESSION["la_nomina"]["peractnom"];
		$li_cuantos=0;
		...
		{
		  $lb_valido=false;
		  $this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_select_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	function uf_insert_salida($as_codper,$as_codconc,$as_tipsal,$ad_valsal,$ad_monacusal,$ad_salsal,$as_quirepcon)
	{
	   ...
	   {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_insert_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	   }
	   return $lb_valido;
	...
	function uf_update_salida($as_codper,$as_codconc,$as_tipsal,$ad_valsal,$ad_monacusal,$ad_salsal,$as_quirepcon)
	{
	   ...
	   {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	   }
	   return $lb_valido;
	...
	function uf_update_salida_desincorpora($as_codper,$as_codconc,$as_tipsal,$ad_valsal,$ad_monacusal,$ad_salsal,$as_quirepcon)
	{
	   ...
	   {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_salida_desincorpora ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	   }
	   return $lb_valido;
									   ...
									   $ai_numcuo,$ai_numpre,$as_quirepcon)
	{
		...
		//                 ai_numcuo  //  n�mero de cuota que se est� pagando
		//                 ai_numpre  //  n�mero del prestamo
		//	      Returns: lb_valido True si se ejecuto el update correctamente � False si hubo error en el update
	...
	function uf_calcular_prestamo_vacaciones($as_codper,&$ad_dedres,&$ad_totnom,&$ad_priquires,&$ad_segquires,$ad_fechafinvac)
	{
		...
		//	      Returns: lb_valido True si se ejecuto  correctamente � False si hubo error calculando los prestamos
		...
		// Fecha Creaci�n: 02/03/2010         								Fecha �ltima Modificaci�n : 14/02/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $ls_peractnom=$_SESSION["la_nomina"]["peractnom"];
		$lb_valido=true;
	   ...
	   {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_calcular_prestamo_vacaciones ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	   }
	   else
	   {
			$li_cuenta=0;
	...
	function uf_calcular_prestamo($as_codper,&$ad_dedres,&$ad_totnom,&$ad_priquires,&$ad_segquires)
	{
	   ...
	   {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_calcular_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	   }
	   else
	   {
			while((!$rs_data->EOF)&&($lb_valido))
	...
	function uf_update_amortizados()
	{
	    ...
	    {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_update_amortizados ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	    }
		if($lb_valido)
		{
			$ls_sql="UPDATE sno_prestamos ".
	...
	function uf_cancelar_prestamos()
	{
		...
		//	  Description: Funci�n que verifica si el amorizado es igual al monto del prestamo se coloca como cancelado
		//	   Creado Por: Ing. Yesenia Moreno
	    ...
	    {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_cancelar_prestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	    }
	   return $lb_valido;
	...
	function uf_suspender_prestamos()
	{
		...
		//                 ai_numpre //  n�mero del prestamo
		//	      Returns: lb_valido  true si actualizo el prestamo o false si hubo un error
		//	  Description: Funci�n que Si el prestamo est� activo pero para el pr�ximo per�odo no tiene las cuotas a cancelar lo
		//					suspende
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 14/02/2006 								Fecha �ltima Modificaci�n :
		////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_suspender_prestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
		}
	   	return $lb_valido;
	...
	function uf_activar_prestamos()
	{
		...
		//                 ai_numpre //  n�mero del prestamo
		//	      Returns: lb_valido  true si actualizo el prestamo o false si hubo un error
		//	  Description: Funci�n que Si el prestamo est� suspendido pero para el pr�ximo per�odo ya tiene las cuotas a cancelar lo
		//					activa
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n : 14/02/2006
		////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_peractnom=$_SESSION["la_nomina"]["peractnom"];
		$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_activar_prestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
		}
	   	return $lb_valido;
   ...
   //-----------------------------------------------------------------------------------------------------------------------------------
								   ...
								   $aa_seguridad)
	{
		...
		//	  Description: funci�n que recalcula las cuotas del prestamo del personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/12/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_amortizarprestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
		}
		if($lb_valido)
		{
		...
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="INSERT";
			$ls_descripcion ="Insert� un amortizado n�mero ".$ai_numamo." Monto ".$ai_montoamortizar." del Prestamo nro ".$ai_numpre." de tipo ".$as_codtippre." del personal ".
							 "".$as_codper." asociado a la n�mina ".$this->ls_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
		...
		if($lb_valido)
		{
			$this->io_mensajes->message("El Monto del prestamo fu� amortizado.");
			$this->io_sql->commit();
		}
		else
		{
	...
	function uf_load_correlativo_amortizado($ai_numpre,&$ai_numamo)
	{
		...
		//		   Access: private (uf_guardar)
		//      Arguments: ai_numamo  // Nuevo n�mero de amortizado
		//	      Returns: lb_valido True si se ejecut� correctamente � False si hubo alg�n error
		//	  Description: Funcion que busca el correlativo del �ltimo prestamo  y genera el nuevo correlativo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 07/02/2006 								Fecha �ltima Modificaci�n :
	...
	function uf_delete_amortizado($as_codper,$as_codtippre,$ai_numpre,$aa_seguridad)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Prestamo M�TODO->uf_delete_amortizado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $lb_valido;
...
//-------------------------------------------------------------------------------------------------------------------------------------
    function uf_contar_prestamos($as_codper,$as_codtippre)
	{
		...
		//				   as_tipopres  // Secci�n a la que pertenece la variable
		//	      Returns: $ls_resultado variable buscado
		//	  Description: Funci�n que cuenta los prestamo del mismo tipo a un personal en estado activo o suspendido
		//	   Creado Por: Ing. Jennifer Rivero
		// Fecha Creaci�n: 27/08/2008								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("M�TODO->uf_contar_prestamos ERROR->".
