...
class sigesp_sno_c_vacacion
{
	...
	function uf_load_totalpersonal($as_codperdes,$as_codperhas,&$ai_totper)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_totalpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
								...
								$ai_sueintvac,$ai_sueintbonvac,$ai_stavac,$ai_diaspermiso,$aa_seguridad)
	{
		...
		//		   Access: private
		//	    Arguments: as_codper  // c�digo del personal                    ai_codvac  // c�digo de vacaci�n
		//				   ad_fecvenvac  // Fecha de Vencimiento				ai_diadisvac  // d�as de vacaciones
		//				   ai_diabonvac  // d�as de bono vacacional				ai_diaadidisvac  // D�as adicionales de vacaciones
		//				   ai_diaadibonvac  // D�as adicionales de bono			ai_sueintvac  // Sueldo integral de vacaciones
		//				   ai_sueintbonvac  // sueldo integral de bono vaca		ai_stavac  // Estatus de Vacaciones
		//                 ai_diapermiso // d�as de permiso descontables
		//	      Returns: lb_valido True si se ejecuto el insert � False si hubo error en el insert
		//	  Description: Funcion que inserta las vacaciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 16/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ld_fecdisvac="";
		$ld_fecreivac="";
		...
		if($lb_valido)
		{
			...
			$ls_obsvac="Vacaci�n Generada Autom�ticamente por el proceso->Generar Vacaciones Vencidas.";
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_insert_vacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
			else
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la vacaci�n ".$ai_codvac." asociado al personal ".$as_codper;
	...
	function uf_load_fechadisfrute($ad_fecvenvac,&$ad_fecdisvac,&$ai_sueintbonvac)
	{
		...
		//	      Returns: lb_valido True si se ejecuto el proceso correctamnte � False si hubo error en el proceso
	...
	function uf_load_fechareingreso($ad_fecdisvac,$ai_diadisvac,$ai_diaadidisvac,&$ad_fecreivac,&$ai_sabdom,&$ai_diafer,$ai_diaspermiso)
	{
		...
		//				   ai_diadisvac  // D�as de Disfrute de las vacaciones
		//				   ai_diaadidisvac  // D�as adicionales de disfrute
		//				   ad_fecreivac  // Fecha de reintegro de las vacaciones
		//				   ai_sabdom  // s�bados y domingos dentro del per�odo de las vacaciones
		//				   ai_diafer  // d�as feriados dentro del per�odo de las vacaciones
		//		           ai_diaspermiso // d�as de permiso descontables de vacaciones
		//	      Returns: lb_valido True si se ejecuto el proceso correctamnte � False si hubo error en el proceso
	...
	function uf_load_periodo($ad_fecper,&$as_codperi)
	{
		...
		//		   Access: private
		//	    Arguments: ad_fecper  // Fecha desde del per�do
		//				   as_codperi  // C�digo del per�odo
		//	      Returns: lb_valido True si se encontro � False si no se encontr�
		//	  Description: Funci�n que obtiene el per�do dada una fecha
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 17/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$as_codperi="000";
								...
								$as_obsvac,$ai_diapag,$ai_pagcan,$ai_dianorvac,$as_peringvac,$as_persalvac,$ai_quisalvac,$ai_quireivac,$as_pagpersal,$as_profueper,$aa_seguridad)
	{
		...
		//				   ai_diavac  // d�as de vacaciones						ai_diaadivac  // D�as adicionales de vacaciones
		//				   ai_diabonvac  // d�as de bono vacacional				ai_diaadibon  // D�as adicionales de bono
		//				   ai_diapenvac  // D�as pendientes de vacaciones		ai_diafer  // D�as feriados
		//				   ai_sabdom  // S�bados y Domingos						ai_sueintvac  // Sueldo integral
		//				   ai_sueintbonvac  // sueldo integral de bono vaca		as_obsvac  // Observaci�n de vacaciones
		//				   ai_diapag  // Disfrut� los d�as						ai_pagcan  // Bono vacacional cancelado
		//				   ai_dianorvac // Dias normales de vaca				as_peringvac // Per�odo de Reingreso
		//				   as_persalvac // Per�odo de salida					ai_quisalvac // Quincena de Salida
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 14/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_update_vacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		...
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� la vacaci�n ".$ai_codvac." asociado al personal ".$as_codper;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			...
			if($lb_valido)
			{
				$this->io_mensajes->message("La Vacaci�n fue Actualizada.");
				$this->io_sql->commit();
			}
			else
			{
	...
	function uf_procesar_vencidas($as_codperdes,$as_codperhas,$aa_seguridad)
	{
		...
		//				   as_codperhas  // c�digo de personal hasta
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecut� correctamente el proceso � False si hubo alg�n error
		...
		{
			$this->io_mensajes->message("ERROR->No hay m�todo de vacaci�n seleccionado.");
		}
		return $lb_valido;
	...
	function uf_procesar_porvencer($ad_codperdes,$ad_codperhas,$aa_seguridad)
	{
		...
		//	    Arguments: ad_codperdes  // c�digo del per�do desde
		//				   ad_codperhas  // c�digo del per�odo hasta
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecut� correctamente el proceso � False si hubo alg�n error
		//	  Description: Funcion que dado un rango de per�odo le genera las vacaciones que se vencen en este rango.
		//	   Creado Por: Ing. Yesenia Moreno
	...
	function uf_load_personalporvencer($ad_codperdes,$ad_codperhas,&$rs_data)
	{
		...
		//		   Access: private
		//	    Arguments: ad_codperdes  // c�digo del periodo desde
		//				   ad_codperhas  // c�digo del per�odo hasta
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_personalporvencer ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_load_ultimavacacion($as_codper,&$ad_fecultvac,&$ai_codvac)
	{
		...
		//	    		   ad_fecultvac  // Fecha de la �ltima vacacaci�n
		//	    		   ai_codvac  // C�digo de la �ltima vacaci�n
		//	      Returns: lb_valido True si se ejecut� el select correctamente � False si hubo alg�n error
		//	  Description: funci�n que dado el c�digo de personal obtiene la �ltima vacacion disfrutada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 20/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_ultimavacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_codigopersonal($as_codperdes,$as_codperhas,&$rs_data)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_codigopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_load_personal($as_codper)
	{
		...
		//	  Description: funci�n que dado el c�digo de personal crea una variable session con todos los datos del personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 15/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_personal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_delete_vacacionpersonal($as_codper,$aa_seguridad)
	{
		...
		//	    Arguments: as_codper  // c�digo de personal
		//	    		   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se eliminaron las vacaciones del personal � False si hubo alg�n error
		//	  Description: funci�n que dado el c�digo de personal le elimina las vacaciones que se han generado
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 15/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_delete_vacacionpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
			$ls_evento="DELETE";
			$ls_descripcion ="Elimin� las vacaciones asociadas al personal ".$as_codper;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////
							  ...
							  &$ai_diaadidisvac,&$ai_diaadibonvac,&$ai_diaspermiso)
	{
		...
		//		   Access: private
		//	    Arguments: as_codper  // c�digo de personal
		//	    		   ad_fecvacant  // fecha de la vacaci�n anterior
		//	    		   ad_fecvacpro  // fecha de la pr�xima vacaci�n
		//	    		   ad_fecvacproper  // fecha de la pr�xima vacaci�n mas los d�as de permiso
		//	    		   ai_codvac  // C�digo de Vacaci�n
		//	    		   ai_diadisvac  // D�as de disfrute
		//	    		   ai_diabonvac  // D�as de Bono vacacional
		//	    		   ai_diaadidisvac  // D�as adicionales de disfrute
		//	    		   ai_diaadibonvac  // D�as adicinales de bono
		//	      Returns: lb_valido True si se cargo perfectamente los valores de las pr�ximas vacaciones � False si hubo alg�n error
		//	  Description: funci�n que dado el c�digo de personal y la fecha de vacaci�n anterior genera las pr�ximas vacaciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 15/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	function uf_load_sueldointegral_vac($as_codper,&$ai_sueintvac,$as_profueper,$ad_fecdisvac)
	{
		...
		//	      Returns: lb_valido True si se obtuvo el sueldo integral de vacaciones correctamente � False si hubo alg�n error
		//	  Description: funci�n que dado el c�digo de personal obtiene el sueldo integral
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 16/03/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_sueldointegral_vac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_sueldobono_vac($as_codper,&$ai_suebonvac)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_sueldobono_vac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_update_sueldointegral_vac($as_codper,$as_codvac,$ai_sueintvac,$ai_suebonvac)
	{
		...
		//	  Description: Funcion que inserta las vacaciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 15/08/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="UPDATE sno_vacacpersonal ".
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_update_sueldointegral_vac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_existe_resumen()
	{
		...
		{
			$lb_valido=true;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_existe_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
									 ...
									 &$ai_quisalvac,&$ai_quireivac,&$ai_sueintvac,$ai_diaspermiso,$as_profueper)
	{
		...
		if($lb_valido===false)
		{
			...
			if($lb_valido)
			{
				...
				$as_obsvac="Vacaci�n Reprogramada.";
		...
		{
			$this->io_mensajes->message("Para este per�odo No se pueden Programar Vacaciones. Ya realiz� el c�lculo de la N�mina. Reverse la N�mina y vuelva a programar");
			$ad_fecdisvac="";
			$lb_correcto=false;
		}
	...
	function uf_load_salidavacacion($as_codper)
	{
		...
		//	    Arguments: as_codper // c�digo de personal
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal verfica si este sale de vacaciones en este per�odo y de ser as� crea una
		...
		if($ls_metodovacaciones!="0")
		{
			...
			if($rs_data===false)
			{
				$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_salidavacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
	...
	function uf_load_vacaciondisfrutada($as_codper)
	{
		...
		//				   variable de session con todos sus atos
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 18/06/2009 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_metodovacaciones=trim($this->io_sno->uf_select_config("SNO","CONFIG","METODO_VACACIONES","0","C"));
		switch ($ls_metodovacaciones)
		...
		if($ls_metodovacaciones!="0")
		{
			...
			if($rs_data===false)
			{
				$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_vacaciondisfrutada ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
	...
	function uf_load_reingresovacacion($as_codper)
	{
		...
		//	    Arguments: as_codper // c�digo de personal
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal verifica si este personal esta de reintegro de vacaciones y crea una
		//				   variable de sessi�n con sus datos
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($ls_metodovacaciones!="0")
		{
			...
			if($rs_data===false)
			{
				$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_load_reingresovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
	...
	function uf_load_conceptovacacion($as_tipo,$as_codper,&$as_sql)
	{
		...
		//		   Access: private
		//	    Arguments: as_tipo // Tipo si es de salida � si es de reingreso
		//				   as_codper // C�digo de personal
		//				   as_sql // Cadena SQL que va a servir para buscar al personal
		//	      Returns: lb_valido True si se creo la Cadena SQL � False si no se creo
		//	  Description: funci�n que dado el tipo de operacion (Salida � Reingreso) crea una cadena SQL para ser ejecutada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	function uf_calcular_vacacion($as_codper,&$ai_total_nomi)
	{
		...
		//	    Arguments: as_codper // c�digo de personal
		//			       ai_total_nomi // Total acumulado de la n�mina
		//	      Returns: lb_valido True si se calculo correctamente las vacaciones al personal False si no se calcularon bien
		//	  Description: funci�n que dado el c�digo de personal se calcula la salida � reingreso de vacaciones de ser as�
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		// Obtener si el personal est� de Salida de Vacaciones
		...
		if($lb_valido)
		{
			// Obtener si el personal est� de Reingreso de Vacaciones
		...
		if($lb_valido)
		{
			...
			if ($li_desincorporar == 0) // se aplica solo cuando no se desincorpora de la n�mina
			{
	...
	function uf_update_vacacioncancelada($as_codper,$as_codvac)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_update_vacacioncancelada ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_procesar_vacacion($as_codper,$as_tipo,&$ai_total_nomi)
	{
		...
		//		   Access: private
		//	    Arguments: as_codper // c�digo de personal
		//				   as_tipo // tipo de calculo si es de salida � de reingreso
		//				   ai_total_nomi // total
		//	      Returns: lb_valido True si se calculo correctamente la salida de vacaciones al personal False si no se calcularon bien
		//	  Description: funci�n que dado el c�digo de personal se calculan la salida de las vacaciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_procesar_vacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
			else
			{
				while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
				{
					...
					$lb_filtro=true;
					$lb_aplica=true;
					if (!(trim($ls_condicion)=="")) // Si tiene una condici�n
					{
						$lb_filtro=false;
	...
	function uf_evaluar_concepto($as_codper,$as_formula,$as_tipo,$ai_minimo,$ai_maximo,$ai_minimopat,$ai_maximopat,&$as_valor)
	{
		...
		//				   as_tipo // si es un concepto normal � es un aporte patronal
		//				   ai_minimo // valor m�nimo que puede tener el concepto
		//				   ai_maximo // valor maximo que puede tener el concepto
		//				   ai_minimopat // valor m�nimo que puede tener el concepto si es un aporte patronal
		//				   ai_maximopat // valor maximo que puede tener el concepto si es un aporte patronal
		//				   as_valor // Valor de la f�rmula
		//	      Returns: lb_valido True si se calculo correctamente la formula False si no se calculo bien
		//	  Description: funci�n que dado el c�digo de personal y la f�rmula se evalua y retorna un valor
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	function uf_procesar_prestamo($as_periodo,$as_codper,$as_tipo,&$ai_acumulado,&$ai_total_nomi,&$ai_total_dedu)
	{
		...
		//		   Access: private
		//	    Arguments: as_periodo // per�odo para el cual se desea calcular las vacaciones
		//				   as_codper // c�digo de personal
		//				   as_tipo // tipo de calculo si es de salida � de reingreso
		//				   ai_acumulado // acumulado total
		//				   ai_total_nomi // monto acumulado de la n�mina
		//				   ai_total_dedu // monto acumulado de deducciones
		//	      Returns: lb_valido True si se proceso correctamente los prestamos � False si hubo alguna falla
		//	  Description: funci�n que dado el c�digo de personal verifica si tiene prestamos asociados y los acumula
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_procesar_prestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_select_salida($as_peractnom,$as_codper,$as_codconc,$as_tipsal)
	{
		...
		//				   as_codper  // C�digo de personal
		//			       as_codconc  // C�digo de Tabla
		//	   			   as_tipsal  // C�digo de Tabla
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si la salida est� registrada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_select_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_hsalida($as_peractnom,$as_codper,$as_codconc,$as_tipsal)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_select_hsalida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_update_salida($as_peractnom,$as_codper,$as_codconc,$as_tipsal,$ai_valsal,$ai_monacusal,$as_quirepcon)
	{
		...
		//	      Returns: lb_valido True si se actualiz� correctamente la salida False si hubo error
		//	  Description: funci�n que actualiza en la tabla de salida el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_update_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
 			$lb_valido=false;
		}
		return $lb_valido;
	...
	function uf_insert_salida($as_peractnom,$as_codper,$as_codconc,$as_tipsal,$ai_valsal,$ai_monacusal,$as_quirepcon)
	{
		...
		//				   ai_valsal // Valor de la Salida
		//				   ai_monacusal // Monto Acumulado de la Salida
		//	      Returns: lb_valido True si se insert� correctamente la salida False si hubo error
		//	  Description: funci�n que inserta en la tabla de salida el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_insert_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
 			$lb_valido=false;
		}
		return $lb_valido;
	...
	function uf_guardar_salida($as_codper,$as_codconc,$as_tipsal,$ai_valsal,$ai_monacusal,$as_tipvac,$as_quirepcon)
	{
		...
		//	  Description: funci�n que guarda en la tabla de salida el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($lb_valido)
		{
			...
			{//Agregado por Carlos Zambrano
				// se inserta la salida de tipo vacaci�n
	...
	function uf_select_programada($as_codper)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_select_programada ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_resumen($as_peractnom,$as_codper)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_select_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_update_resumen($as_peractnom,$as_codper,$ai_asires,$ai_dedres,$ai_apoempres,$ai_apopatres,$ai_priquires,$ai_segquires,$ai_monnetres)
	{
		...
		//		   Access: private
		//	    Arguments: as_peractnom // periodo actual de la n�mina
		//				   as_codper // c�digo de personal
		//				   ai_asires // monto de asignaci�n
		//				   ai_dedres // monto de deducci�n
		//				   ai_apoempres // monto de aporte de empleados
		//				   ai_apopatres // monto de aporte de  patr�n
		//				   ai_priquires // monto de primera quincena
		//				   ai_segquires // monto de segunda quincena
		//				   ai_monnetres // monto neto
		//	      Returns: lb_valido True si se actualiz� correctamente el resumen False si hubo error
		//	  Description: funci�n que actualiza en la tabla de resumen el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_update_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
 			$lb_valido=false;
		}
		return $lb_valido;
	...
	function uf_insert_resumen($as_peractnom,$as_codper,$ai_asires,$ai_dedres,$ai_apoempres,$ai_apopatres,$ai_priquires,$ai_segquires,$ai_monnetres)
	{
		...
		//				   ai_segquires // monto de segunda quincena
		//				   ai_monnetres // monto neto
		//	      Returns: lb_valido True si se insert� correctamente el resumen False si hubo error
		//	  Description: funci�n que inserta en la tabla de resumen el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_insert_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
 			$lb_valido=false;
		}
		return $lb_valido;
	...
	function uf_guardar_resumen($as_codper,$ai_asires,$ai_dedres,$ai_apoempres,$ai_apopatres,$ai_priquires,$ai_segquires,$ai_monnetres)
	{
		...
		//	  Description: funci�n que guarda en la tabla de resumen el concepto que se evaluo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	function uf_buscarfueraperiodo($as_codper)
	{
		...
		// Fecha Creaci�n: 24/11/2009 								Fecha �ltima Modificaci�n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;
		$ls_sql="SELECT sno_personalnomina.codper, sno_personalnomina.sueper, sno_personalnomina.horper, ".
						"  		sno_personalnomina.quivacper, sno_personalnomina.staper, sno_vacacpersonal.codvac, ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Vacaci�n M�TODO->uf_buscarfueraperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
